function (expectedPrompt, expectedModel, performClick = true) {
  ...
  if (document.querySelector('[data-testid="stop-button"]')) return 'E_BROWSER_BUSY';
  if (send.disabled) return 'E_SEND_DISABLED';
  if (performClick) send.click();
  return true;
}
